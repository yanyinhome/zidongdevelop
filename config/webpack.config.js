...
module.exports = function (webpackEnv) {
    ...
    // 配置入口
    // const entry = {vendor: Object.keys(appPackageJson.dependencies)}
    const entry = {vendor: ["react", "js-md5", "axios"]}
    ...
    return {
        ...
        // connect to WebpackDevServer by a socket and get notified about changes.entry
        ...
        plugins: [
            ...
            // process.env.NODE_ENV === 'production' ? new BundleAnalyzerPlugin({openAnalyzer: false}) : false
        ].filter(Boolean),
